...
class LinExpr:
    ...
    def linTerms(self) -> Iterable[Tuple[float, Var]]: ...
    @overload
...
class Model:
    ...
    def cbSetParam(self, paramname: str, newval: float) -> None: ...
    @overload
    ...
    def copy(self, env: Optional[Env] = None) -> Model: ...
...
class QuadExpr:
    ...
    def linTerms(self) -> Iterable[Tuple[float, Var]]: ...
    def quadTerms(self) -> Iterable[Tuple[float, Var, Var]]: ...
    @overload
    def remove(self, __which: int) -> None: ...
    @overload
    def remove(self, __which: Var) -> None: ...
